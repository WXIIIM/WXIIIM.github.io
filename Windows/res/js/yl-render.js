    ...
    methods: {
      ...
      initRuntime: function (first) {
        ...
        if (first && !YL.static.serialNumber) {
          YL.onReady(function () {
            setTimeout(function () {
              YL.msg("吴邪IIIM's Windows", 'Hello，你好，欢迎！<br/>个人主页：' + '<a style="color: white" target="_blank" href="http://wxiiim.github.io/"> wxiiim.github.io </a><br />本网站 UI 由 ' + '<a style="color: white" target="_blank" href="https://ylui.yuri2.cn"> YLUI </a> 强力驱动<p>');
            }, 1500)
          });
        }
